...
public class SDES {
	...
	public static byte[] Encrypt(byte[] rawkey, byte[] plaintext) {
		...
		/**System.out.println("10-bit Raw Key:  "+ Arrays.toString(rawkey));
		System.out.println("8-bit Plain Text: "+Arrays.toString(plaintext));
		System.out.println("8-bit Cipher text:  "+ Arrays.toString(ciphertext)+'\n');
		**/
		return ciphertext;
	}
